...
(function(){
	...
	.config(['$routeProvider', '$stateProvider', '$authProvider', '$urlRouterProvider', '$httpProvider', '$provide',
		configFunction
	])
	.run(['$rootScope', '$state',
		runFunction
	...
	function configFunction($routeProvider, $stateProvider, $authProvider, $urlRouterProvider, $httpProvider, $provide) {
